          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div className="max-w-[500px] mx-auto md:mx-0 text-center md:text-left">
              ...
              <p className="text-[#161616] sm:text-xl font-light">
                Provision your compute, network, and storage resources on a
            ...
            <div className="flex justify-center lg:justify-end">
              <div className="w-full max-w-2xl rounded-lg flex items-center justify-center">
                <img
                  src="https://cms.anonymous-proxies.net/media/datacenter.png"
                  alt=""
                />
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="border border-gray-200 rounded-lg p-6 hover:shadow-lg transition-shadow bg-white min-h-[220px] flex flex-col justify-between">
              <div>
                ...
                <p className="text-gray-600 text-sm mb-8">
                  Use the Cloud foundation for VPC deployable architecture to
                  automate your 3-tier network architecture.
                </p>
              </div>
            ...
            <div className="border border-gray-200 rounded-lg p-6 hover:shadow-lg transition-shadow bg-white min-h-[220px] flex flex-col justify-between">
              <div>
                ...
                <p className="text-gray-600 text-sm mb-8">
                  Access your classic virtual servers, bare metal servers,
                  VMware, and supporting infrastructure in Classic
                  Infrastructure.
                </p>
              </div>
              <div className="flex items-center justify-center w-12 h-12 bg-gray-50 rounded">
            ...
            <div className="border border-gray-200 rounded-lg p-6 hover:shadow-lg transition-shadow bg-white min-h-[220px] flex flex-col justify-between">
              <div>
                ...
                <p className="text-gray-600 text-sm mb-8">
                  Use Power Virtual Server to leverage Power with the benefits
            ...
            <div className="space-y-4">
              ...
              <div className="border border-gray-200 rounded-lg p-4 flex flex-col sm:flex-row items-start sm:items-center gap-4 bg-[#f4f4f4] hover:bg-[#e8e8e8] transition-colors">
                <div className="flex sm:items-center gap-3 flex-1 flex-col-reverse sm:flex-row w-full">
                  <button
                    className="bg-[#e0e0e0] px-3 py-2 text-sm text-[#161616] flex items-center gap-3 font-mono sm:min-w-[140px] justify-between group cursor-pointer hover:bg-[#d1d1d1] rounded w-full sm:w-auto"
              ...
              <div className="border border-gray-200 rounded-lg p-4 flex flex-col sm:flex-row items-start sm:items-center gap-4 bg-[#f4f4f4] hover:bg-[#e8e8e8] transition-colors">
                <div className="flex sm:items-center gap-3 flex-1 flex-col-reverse sm:flex-row w-full">
                  ...
                  <p className="text-sm text-blue-600">
                    Get $1000 in credits to deploy Confidential Compute,
